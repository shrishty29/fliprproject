...
<%@page  import="java.sql.ResultSet,java.util.ArrayList" %>
       <% Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        c.prepareStatement("select * from usertable");
        ...
        %>
        <h1 style="color: white; font-family: arial" align="center">All users list</h1>
        <table width='100%'  class='tabtheme'  style="border: black">
            <tr>
                <td class='tdtheme'>User id </td>
                <td class='tdtheme'>Name</td>
                <td class='tdtheme'>Email</td> 
                <td class='tdtheme'>Aadhar no.</td>
                <td class='tdtheme'>License no.</td>
                <td class='tdtheme'>Address</td>
                <td class='tdtheme'>Password</td>
            </tr>
