...
<%@page  import="java.sql.ResultSet,java.util.ArrayList" %>
       <% Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        c.prepareStatement("select * from feedback");
        ...
        %>
        <h1 style="color: white; font-family: arial" align="center">feedback</h1>
        <table width='100%'  class='tabtheme'  style="border: black">
            <tr>
                <td class='tdtheme'>date </td>
                <td class='tdtheme'>userid</td>
                <td class='tdtheme'>feedback type</td> 
                <td class='tdtheme'>content</td>
