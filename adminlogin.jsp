...
<%
    ...
    if (button1 != null && button1.equals("LOGIN")) {
        ...
        PreparedStatement st = c.prepareStatement("select * from admin where adminid=? and password=?");
        st.setString(1, adId);
    ...
    <div class="divtheme">
        ...
        <table align="center" cellspacing="20px" >
            ...
            <tr>
                ...
                <td>admin id</td>
                <td><input type="text"  name="aid" placeholder="Enter user name" class="texttheme"></td>
            </tr>
            <tr>
