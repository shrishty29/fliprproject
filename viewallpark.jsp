...
<%@page  import="java.sql.ResultSet,java.util.ArrayList" %>
       <% Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        c.prepareStatement("select * from parkingspottable");
        ...
        %>
        <h1 style="color: white; font-family: arial" align="center">Parking</h1>
        <table width='100%'  class='tabtheme'  style="border: black">
            <tr>
                <td class='tdtheme'>Spot id </td>
                <td class='tdtheme'> Spot Name</td>
                <td class='tdtheme'>Location</td> 
                <td class='tdtheme'>Avail_Status</td>
                <td class='tdtheme'>Priceperhour</td>
                <td class='tdtheme'>Vehical no </td>
            </tr>
